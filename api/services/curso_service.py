...
def listar_cursos():
    # Retorna todos os registros "query.all()"
    cursos = curso_model.Curso.query.all()
    return cursos

def listar_curso_id(id):
    # Filtrando por id com o query.filter_by e logo depois passando que queremos o primeiro registro da tabela com first()
